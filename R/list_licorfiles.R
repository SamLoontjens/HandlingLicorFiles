...
#'
list_licorfiles <- function(directory = ""){

  #make the pathname to list
  pathname <- paste0("input_directory_licorfiles/", directory)

  #list all the licorfiles in that directory
